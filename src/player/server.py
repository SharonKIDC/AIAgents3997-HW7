...
class PlayerServer(AgentServerBase):
    ...
    def register(self) -> bool:
        ...
        """
        return self._do_register(MessageType.REGISTER_PLAYER_REQUEST, "player_id")
    ...
    def _handle_request_internal(self, request: JSONRPCRequest) -> JSONRPCResponse:
        ...
        if response_type:
            ...
            response_envelope = self._create_response_envelope(
                response_type, envelope.conversation_id, envelope.match_id
            )
    ...
    def _handle_game_invitation(
        ...
        # Track match
        self.current_matches[match_id] = {"game_type": game_type, "opponents": opponents}

        return {"status": "accepted", "match_id": match_id}

    def _handle_move_request(self, _envelope: Envelope, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"move_payload": move}

    def _handle_game_over(self, envelope: Envelope, payload: Dict[str, Any]) -> Dict[str, Any]:
