...
class TestRoundRobinScheduler:
    ...
    def test_schedule_generation_two_players(self, scheduler, league_with_players, temp_db):
        ...
        players = ["alice", "bob"]
        schedule = scheduler.generate_schedule(league_with_players, players, "tic_tac_toe")
    ...
    def test_schedule_determinism(self, scheduler, league_with_players):
        ...
        schedule1 = scheduler.generate_schedule(league_with_players, players, "tic_tac_toe")
    ...
    def test_schedule_empty_players(self, scheduler, league_with_players):
        ...
        schedule = scheduler.generate_schedule(league_with_players, [], "tic_tac_toe")
    ...
    def test_schedule_single_player(self, scheduler, league_with_players):
        ...
        schedule = scheduler.generate_schedule(league_with_players, ["alice"], "tic_tac_toe")
    ...
    def test_schedule_player_order_independence(self, scheduler, league_with_players):
        ...
        schedule1 = scheduler.generate_schedule(league_with_players, players1, "tic_tac_toe")

        schedule2 = scheduler.generate_schedule("league-2", players2, "tic_tac_toe")
