...
class TestValidationFunctions:
    ...
    def test_validate_uuid_invalid(self):
        ...
        invalid_uuids = ["not-a-uuid", "12345", "abc-def-ghi"]
...
class TestJSONRPCResponse:
    ...
    def test_jsonrpc_response_success(self):
        ...
        response = JSONRPCResponse(jsonrpc="2.0", result={"status": "ok"}, id="test-id")
...
class TestHelperFunctions:
    ...
    def test_create_error_response(self):
        ...
        response = create_error_response(
            ErrorCode.VALIDATION_ERROR, "Test validation error", {"field": "test"}, "req-123"
        )
    ...
    def test_create_error_response_no_request_id(self):
        ...
        response = create_error_response(ErrorCode.INVALID_JSON_RPC, "Invalid JSON", None, None)
